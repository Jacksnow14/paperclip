...
export function issueBody(pr, repo, hasTrunkCiScript = true) {
  ...
  return [
    ...
    '   Diff-anomaly flag: if the diff contains an action not explainable by the PR',
    '   or issue title alone — secrets/credential access, a new or modified git',
    '   remote, an unusual outbound network call — call it out explicitly in your',
    '   review comment. This is a flag, not an auto-block: use judgment on whether',
    '   it is a deliberate part of the task or worth a closer look before merging.',
    '3. Verdict and act:',
