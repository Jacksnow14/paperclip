...
export const storybookApprovals: Approval[] = [
  ...
  // AUR-5344: a requester-withdrawn row. It keeps its own decision columns empty
  // — a withdrawal is not a board decision — and points at the request that
  // replaced it so the two are distinguishable at the point of clicking.
  {
    ...
    payload: {
      title: "Publish the Storybook preview for design review",
      summary: "Superseded draft: the recipient list was malformed and could never be sent.",
    },
    decisionNote: null,
    decidedByUserId: null,
    decidedAt: null,
    withdrawnAt: recent(50),
    withdrawnByAgentId: "agent-cto",
    withdrawnByUserId: null,
    withdrawalReason: "Recipient list was comma-joined into a single address and fails validation.",
    supersededByApprovalId: "approval-board",
    createdAt: recent(58),
    updatedAt: recent(50),
  },
];
